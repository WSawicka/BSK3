...
public class Tables {
    ...
    public Tables() {
        ...
        this.sTables.add(this.s1);
        this.sTables.add(this.s2);
        this.sTables.add(this.s3);
        this.sTables.add(this.s4);
        this.sTables.add(this.s5);
        this.sTables.add(this.s6);
        this.sTables.add(this.s7);
        this.sTables.add(this.s8);
    }

    private final int[] pc1Table = // key
            {57, 49, 41, 33, 25, 17, 9,
                1, 58, 50, 42, 34, 26, 18,
                10, 2, 59, 51, 43, 35, 27,
                19, 11, 3, 60, 52, 44, 36,
                ...
                14, 6, 61, 53, 45, 37, 29,
                21, 13, 5, 28, 20, 12, 4};
    private final int[] pc2Table = // key
            {14, 17, 11, 24, 1, 5,
                3, 28, 15, 6, 21, 10,
                23, 19, 12, 4, 26, 8,
                16, 7, 27, 20, 13, 2,
                ...
                44, 49, 39, 56, 34, 53,
                46, 42, 50, 36, 29, 32};
    private final int[] ipTable = // initial permutation table
    ...
    private final int[] eTable = // E bit-selection table
            {32, 1, 2, 3, 4, 5,
                ...
                24, 25, 26, 27, 28, 29,
                28, 29, 30, 31, 32, 1};
    private final int[] shiftKeyTable = {1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};
    ...
    private final int[] pTable = //p permutation table
            {16, 7, 20, 21,
                29, 12, 28, 17,
                1, 15, 23, 26,
                5, 18, 31, 10,
